...
const SkillsSection: React.FC = () => {
  ...
  const skills = [
    { name: "UI/UX Design", icon: FaPaintBrush, label: "Design" },
    { name: "React", icon: FaReact, label: "Frontend" },
    { name: "TypeScript", icon: FaCode, label: "Coding" },
    { name: "Figma", icon: FaFigma, label: "Prototyping" },
    { name: "Responsive Design", icon: FaLaptop, label: "Layout" },
  ];
          ...
          return (
            ...
            >
              <div className="relative">
                <div className={`absolute -top-16 left-1/2 transform -translate-x-1/2 w-14 h-14 rounded-md ${isDarkTheme ? 'bg-gray-700' : 'bg-gray-400'} flex items-center justify-center`}>
