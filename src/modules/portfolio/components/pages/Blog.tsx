  ...
  const services = [
    {
      ...
      description:
        "Custom, responsive web solutions using React and TypeScript.",
      icon: RocketOutlined,
    },
    {
      title: "Teaching Front-end and C++",
      description:
        "Expert instruction in front-end development with React, TypeScript, and C++ programming for robust applications.",
      icon: BulbOutlined,
    },
    {
      title: "Consulting",
      description:
        "Expert advice on tech stack selection and project strategy.",
      icon: TeamOutlined,
    },
  ];
        ...
        <div className="p-4 md:p-6 lg:p-10 font-mono">
          ...
          <div className="mb-10 text-center">
            ...
            <p className="mt-4 text-lg md:text-xl">
              Explore our blog for insights, services, and partnerships in the
              tech world.
            </p>
          </div>
